# Integration - The Four Steps to the Epiphany

## Relationship to Other Skills

### Four Steps → Crossing the Chasm

**Four Steps covers what happens BEFORE the chasm. Crossing the Chasm covers what happens AT the chasm.**

| Dimension | Four Steps | Crossing the Chasm |
|---|---|---|
| **Focus** | Finding customers and a business model | Moving from early adopters to mainstream |
...
- Both recognize that early customers are TERRIBLE references for mainstream
- Four Steps' "Customer Creation" step partially covers chasm territory
- Both reference Geoffrey Moore (Blank acknowledges Moore as a key influence)
...
### Four Steps → Lean Startup (Eric Ries)

**Lean Startup is the direct descendant of Four Steps.** Eric Ries was one of Blank's first implementers at IMVU - the book was required reading for every new hire.

| Dimension | Four Steps (2005) | Lean Startup (2011) |
|---|---|---|
| **Core loop** | Customer Discovery ↔ Customer Validation (iterative circles) | Build → Measure → Learn |
| **Pivot concept** | Validation fails → return to Discovery | Formalized as "pivot" with specific types |
| **Product approach** | "First release for the few, not the many" | Minimum Viable Product (MVP) |
| **Speed of iteration** | Weeks to months per cycle | Days to weeks (especially web/mobile) |
| **Validation method** | Founder-led customer conversations + sales | Experiments, A/B tests, cohort analysis + conversations |
| **Audience** | Enterprise B2B, hardware, deep tech | Web/mobile startups, SaaS |

**What Ries added:**
- The MVP concept (making the "first release for the few" more explicit and faster)
- Innovation accounting (quantitative metrics for validated learning)
- Specific pivot types (zoom-in, zoom-out, customer segment, platform, etc.)
- Applicability to web/mobile startups where iteration is measured in days

**What Blank has that Ries doesn't:**
- Market Type framework (existing/new/resegmented) - Lean Startup doesn't address this
- Customer Creation step (how to launch and create demand) - Lean Startup stops at product/market fit
...
**Tension: Vision-first vs. customer-first.**

| Dimension | Four Steps | Mom Test |
|---|---|---|
...
### Four Steps → SPIN Selling

**Four Steps' Customer Validation phase needs a selling methodology. SPIN Selling provides one.**

| Dimension | Four Steps | SPIN Selling |
|---|---|---|
...
### Four Steps → $100M Offers

**Tension: offer-first vs. discovery-first.**

| Dimension | Four Steps | $100M Offers |
|---|---|---|
| **Starting point** | Hypothesis about customer problem | Craft an irresistible offer |
| **Validation** | Iterative customer conversations + sales | Market response to the offer |
| **Pricing** | Discovered through validation | Engineered into the offer structure |

**Where they conflict:**
- $100M Offers assumes you know who the customer is and what they want. Four Steps says you probably don't.
- $100M Offers focuses on offer construction (bonuses, guarantees, scarcity, urgency). Four Steps focuses on whether anyone wants what you're building at all.
...
**Where they complement:**
- Four Steps provides the Market Type framework (existing/new/resegmented) that determines the TYPE of positioning
- Obviously Awesome provides the tactical process for CRAFTING the positioning
...
### Four Steps → Monetizing Innovation

| Dimension | Four Steps | Monetizing Innovation |
|---|---|---|
| **Pricing** | Discovered through Customer Validation (sell at list price as sanity test) | Designed into the product from the start |
| **Segmentation** | Market Type (4 types) | Willingness-to-pay segments |
...
### Four Steps → Blue Ocean Strategy

| Dimension | Four Steps | Blue Ocean Strategy |
|---|---|---|
| **Market approach** | Four Market Types (including "new market") | Create uncontested market space |
| **Competitive analysis** | Lanchester rules for existing markets | Strategy canvas to find blue oceans |
...
- Four Steps provides the operational process (four steps) for what to do once you've identified the blue ocean

---

## Market Type Mapping to Technology Adoption Life Cycle (TALC)

| TALC Stage | Four Steps Equivalent |
|---|---|
| Innovators / Tech Enthusiasts | Pre-Customer Discovery targets. "They very rarely buy anything." |
| Early Adopters / Visionaries | **Earlyvangelists.** Customer Discovery + Customer Validation targets. |
| The Chasm | Gap between Customer Validation and successful Customer Creation |
| Early Majority / Pragmatists | Customer Creation + early Company Building targets |
| Late Majority / Conservatives | Company Building (process-centric phase) targets |

**Important:** Blank explicitly warns against using the TALC curve too early:
