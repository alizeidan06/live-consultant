---
name: founder-playbook-lean-startup
description: "Apply the pinned AgentSeal Lean Startup lens to MVPs, Build-Measure-Learn loops, innovation accounting, pivot decisions, cohort metrics, and experiments under uncertainty. Use when the user needs the smallest test that can produce validated learning."
---
...
- [SKILL.md](../../assets/upstream-founder-playbook/lean-startup/SKILL.md)
- [cases.md](../../assets/upstream-founder-playbook/lean-startup/cases.md)
- [examples.md](../../assets/upstream-founder-playbook/lean-startup/examples.md)
- [frameworks.md](../../assets/upstream-founder-playbook/lean-startup/frameworks.md)
- [integration.md](../../assets/upstream-founder-playbook/lean-startup/integration.md)
...
An MVP must still be ethical, safe, legally supportable, and capable of testing the real risk. Activity and feature shipping are not validated learning.
