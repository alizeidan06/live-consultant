---
name: founder-playbook-obviously-awesome
description: "Apply the pinned AgentSeal Obviously Awesome positioning lens. Use to identify real competitive alternatives, unique attributes, buyer value, best-fit segments, market category, and relevant trends when buyers misunderstand or miscompare a product."
---
...
- [SKILL.md](../../assets/upstream-founder-playbook/obviously-awesome/SKILL.md)
- [cases.md](../../assets/upstream-founder-playbook/obviously-awesome/cases.md)
- [examples.md](../../assets/upstream-founder-playbook/obviously-awesome/examples.md)
- [frameworks.md](../../assets/upstream-founder-playbook/obviously-awesome/frameworks.md)
- [integration.md](../../assets/upstream-founder-playbook/obviously-awesome/integration.md)
...
Positioning clarifies proved value; it cannot create demand or capability. Competition is category evidence, not automatic disqualification.
