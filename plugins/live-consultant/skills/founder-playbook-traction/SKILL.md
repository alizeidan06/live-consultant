---
name: founder-playbook-traction
description: "Apply the pinned AgentSeal Traction Bullseye lens to enumerate, rank, cheaply test, and focus acquisition channels. Use when a product has enough evidence to test distribution or when growth effort is scattered across too many channels."
---
...
- [SKILL.md](../../assets/upstream-founder-playbook/traction/SKILL.md)
- [cases.md](../../assets/upstream-founder-playbook/traction/cases.md)
- [examples.md](../../assets/upstream-founder-playbook/traction/examples.md)
- [frameworks.md](../../assets/upstream-founder-playbook/traction/frameworks.md)
- [integration.md](../../assets/upstream-founder-playbook/traction/integration.md)
...
Update the channel set for current privacy, platform, PLG, AI, short-form, and partner conditions. Count channel activity as traction when qualified contribution and repeatability are visible.
