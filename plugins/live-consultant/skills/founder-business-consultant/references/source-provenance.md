...
## AgentSeal Founder Playbook

- Source: https://github.com/getagentseal/founder-playbook.git
- Pinned commit: `67f25d1852547a131cd5b6b43b2fbf44d08ed8ec`
- Integrity: `git fsck --full` passed; every tracked file was readable.
- Inventory: 91 files, including 75 Markdown files, 15 images, and one MIT
...
- Omitted: 14 commercial book covers and one banner. Their hashes and paths are
  ...
  no functional knowledge.
- Public export: 73 Markdown files plus the MIT license. It excludes the
  upstream packaging README and the experiment containing third-party community
...
The PDFs were read locally but are not packaged.

| Source | Pages | SHA-256 | Extraction note |
|---|---:|---|---|
| `Meta-Ads-Playbook.pdf` | 73 | `e3b9d4391aee317e8279a3dab3f6cf1c5ef705d3ada3de40dc634a0649351940` | text extraction plus visual checks |
| `5waystodoublesales (1).pdf` | 24 | `8f68db097bbcc5bc712d70eb4a0f291052820219fb48402d8226839262bad360` | all pages recovered with local vision OCR and visual checks |
...
- Markdown-only source: no live account access, connectors, calculators, or
  implementation tools.
- No substantive primary citations for many numerical and historical claims.
- Material gaps in corporate structure, tax, finance, HR, operations, security,
  analytics engineering, checkout operations, and formal decision theory.
- The active wrappers preserve the source's bold offer examples and
  direct-response mindset during ideation. Potential execution risks involving
