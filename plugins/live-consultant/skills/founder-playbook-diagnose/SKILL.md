...
description: "Route an ambiguous startup problem through the pinned AgentSeal diagnostic lens. Use when the user explicitly wants the Founder Playbook router, asks where to start, or presents several overlapping startup symptoms. Prefer founder-business-consultant for a full business, operations, compliance, or cross-domain diagnosis."
---
