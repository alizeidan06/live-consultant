---
name: founder-playbook-diagnose
description: "Apply the pinned AgentSeal diagnostic lens to an ambiguous startup problem while assembling every other framework with a distinct contribution. Use when the user explicitly wants the Founder Playbook router, asks where to start, presents overlapping startup symptoms, or needs this lens inside a full business, operations, compliance, or cross-domain diagnosis. The founder-business-consultant may own the synthesis without displacing this lens."
---
