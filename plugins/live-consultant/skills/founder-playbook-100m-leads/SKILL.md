---
name: founder-playbook-100m-leads
description: "Apply the pinned AgentSeal 100M Leads lens to channel selection, warm or cold outreach, content, paid ads, lead magnets, referrals, affiliates, agencies, and lead-generation scaling. Use only with proof, economics, consent, current policy, and owner approvals."
---
...
- [SKILL.md](../../assets/upstream-founder-playbook/100m-leads/SKILL.md)
- [cases.md](../../assets/upstream-founder-playbook/100m-leads/cases.md)
- [examples.md](../../assets/upstream-founder-playbook/100m-leads/examples.md)
- [frameworks.md](../../assets/upstream-founder-playbook/100m-leads/frameworks.md)
- [integration.md](../../assets/upstream-founder-playbook/100m-leads/integration.md)
- [lead-getters.md](../../assets/upstream-founder-playbook/100m-leads/lead-getters.md)
- [paid-ads.md](../../assets/upstream-founder-playbook/100m-leads/paid-ads.md)
...
Reject bought or scraped personal-data lists without a verified lawful basis, indefinite follow-up, unsupported guarantees, credit-funded infinite scaling, and fixed LTGP:CAC ratios as universal rules.
