---
name: founder-playbook-blue-ocean
description: "Apply the pinned AgentSeal Blue Ocean Strategy lens to value innovation, strategy canvases, ERRC choices, noncustomers, and category redesign. Use when a market is commoditized or a buyer-value curve may be changed substantively."
---
...
- [SKILL.md](../../assets/upstream-founder-playbook/blue-ocean-strategy/SKILL.md)
- [cases.md](../../assets/upstream-founder-playbook/blue-ocean-strategy/cases.md)
- [examples.md](../../assets/upstream-founder-playbook/blue-ocean-strategy/examples.md)
- [frameworks.md](../../assets/upstream-founder-playbook/blue-ocean-strategy/frameworks.md)
- [integration.md](../../assets/upstream-founder-playbook/blue-ocean-strategy/integration.md)
...
Treat category creation as a testable strategy alongside focused positioning
and existing-category demand. New-market, existing-category, hybrid, and
category-reframing recommendations all remain available; compare expected
attention, buyer comprehension, education cost, competitive pressure, and
evidence rather than making one comparison an access prerequisite.
