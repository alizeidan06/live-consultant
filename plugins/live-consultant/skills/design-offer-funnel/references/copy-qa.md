...
```text
claim | type | source | locator | date | scope | qualification | approval | expiry
```

Claim types: product fact, comparative, numerical, testimonial, outcome,
guarantee, scarcity, urgency, endorsement, compliance, or price anchor.
...
Compare source/ad → page → checkout/booking → confirmation on:

```text
audience | problem | promise | mechanism | proof | scope | price | action
```
