---
name: founder-playbook-storybrand
description: "Apply the pinned AgentSeal StoryBrand lens to customer-centered brand messaging, homepages, lead generators, campaigns, and email structure. Use when a proved offer is confusing, self-centered, or lacks a clear problem, guide, plan, action, success, and consequence."
---
...
- [SKILL.md](../../assets/upstream-founder-playbook/storybrand/SKILL.md)
- [cases.md](../../assets/upstream-founder-playbook/storybrand/cases.md)
- [examples.md](../../assets/upstream-founder-playbook/storybrand/examples.md)
- [frameworks.md](../../assets/upstream-founder-playbook/storybrand/frameworks.md)
- [integration.md](../../assets/upstream-founder-playbook/storybrand/integration.md)
...
The customer-as-hero story is a communication pattern, not buyer proof. Do not exaggerate stakes, invent failure, or force every page into the same narrative when intent requires a shorter path.
