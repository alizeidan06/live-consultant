---
name: founder-playbook-mom-test
description: "Apply the pinned AgentSeal Mom Test lens to customer interviews and idea discovery. Use for non-leading questions, learning from past behavior, deflecting compliments, customer segmentation, commitment signals, and reviewing interview scripts or notes without treating polite interest as demand."
---
...
- [SKILL.md](../../assets/upstream-founder-playbook/mom-test/SKILL.md)
- [cases.md](../../assets/upstream-founder-playbook/mom-test/cases.md)
- [examples.md](../../assets/upstream-founder-playbook/mom-test/examples.md)
- [frameworks.md](../../assets/upstream-founder-playbook/mom-test/frameworks.md)
- [integration.md](../../assets/upstream-founder-playbook/mom-test/integration.md)
...
Interview evidence is one input. Require provenance, exact-buyer scope, behavior, paid tradeoffs, disconfirming evidence, and consent/privacy controls before claiming validation.
