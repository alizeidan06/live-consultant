---
name: founder-playbook-crossing-the-chasm
description: "Apply the pinned AgentSeal Crossing the Chasm lens to B2B technology moving from visionary early adopters toward pragmatic mainstream buyers. Use for beachhead selection, whole-product gaps, reference customers, and concentrated niche expansion when the adoption pattern actually fits."
---
...
- [SKILL.md](../../assets/upstream-founder-playbook/crossing-the-chasm/SKILL.md)
- [cases.md](../../assets/upstream-founder-playbook/crossing-the-chasm/cases.md)
- [examples.md](../../assets/upstream-founder-playbook/crossing-the-chasm/examples.md)
- [frameworks.md](../../assets/upstream-founder-playbook/crossing-the-chasm/frameworks.md)
- [integration.md](../../assets/upstream-founder-playbook/crossing-the-chasm/integration.md)
...
Explain the complete sequence for PLG, consumer, marketplace, services, and
AI-native adoption, then analyze its underperformance risks and fit against the
actual adoption mechanism. The upstream source itself flags major
